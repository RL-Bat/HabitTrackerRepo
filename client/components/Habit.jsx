...
const Habit = (props) => {
  ...
  return (
    ...
    {/* Each card and button are passed dynamic variables, that are defined via its current state */}
      <p><strong>Habit: </strong>{habitInfo.name || habitInfo.habit} </p>
      <p><strong>Type: </strong>{habitInfo.positive || habitInfo.type} </p>
      <p><strong>Goal: </strong>{habitInfo.totalAmountWanted || habitInfo.totalAmountsWanted} </p>
      <p><strong>Progress: </strong>{habitInfo.runningTotal || habitInfo.total} </p>
      <p>Did you maintain your goal today?</p>
